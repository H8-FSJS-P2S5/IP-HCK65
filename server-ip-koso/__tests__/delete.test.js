...
//     // console.log(await Lodging.findAll())
//   } catch (error) {
...
//   test("should return message that states the delete has been successful", async () => {
//     let lodgingId = 3;
//     let findLodging = await Lodging.findByPk(lodgingId);
...
//       "message",
//       `Lodging with lodging name: ${findLodging.name} has been deleted`
//     );
//   });
...
//   test("should return error staff is unauthorized to delete someone else's data", async () => {
//     let lodgingId = 1;
//     let response = await request(app)
//       .put(`/lodgings/${lodgingId}`)
